...
public:
	...
	/** Fired when the player clicks the skill-tree button on a skill picker entry.
	 *  Bind in the HUD BP to open UFP_SkillTreePanel::OpenForSkill. */
	UPROPERTY(BlueprintAssignable, Category="Skill Tree")
	FSkillLibraryInfosignature OnSkillTreeRequested;
